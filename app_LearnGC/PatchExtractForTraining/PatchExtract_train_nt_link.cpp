...
int main(int argc, char* argv[])
{
		...
		//mainfold = "E:\\LA_Segmentation\\TraningData\\CASA_AF_May20Data_43_21";
		...
		string PMaxOffset = to_string(MaxOffset);
		...
		//string T_SaveFoldScar = PatchFold + "Patch_T_info_" + PMaxOffset + ".txt";
		//string T_SaveFoldNorm = PatchFold + "Patch_T_info_norm_" + PMaxOffset + ".txt";
		//string N_SaveFold = PatchFold + "Patch_N_info_" + PMaxOffset + ".txt";
		...
		for (int ptId = 0; (ScarNumIdex < Num_Scar) || (NormalNumIdex < Num_Normal); ptId++)
		{
			...
			//float randoffset = float((rand() % 400) - 200) / 100.0;//rand shift	
		...
		//string Str_T = PatchFold + "Patch_T_" + PMaxOffset + ".nii.gz";
		//string Str_N1 = PatchFold + "Patch_N1_" + PMaxOffset + ".nii.gz";
		//string Str_N2 = PatchFold + "Patch_N2_" + PMaxOffset + ".nii.gz";

		zxh::SaveImage(&T_PatchImage, Str_T);
		zxh::SaveImage(&T_PatchImage, Str_N1);
		zxh::SaveImage(&N_PatchImage, Str_N2);

		//delete[] bufferTscar;delete[] bufferTnormal;	delete[] bufferNlink;
