...
{
	string mainfold, Datafold, TargetImageName, MeshWallName, mesh_name, LABloodPoolGaussianBlurName, \
	...
	//string  casename = "C34_Post";
	//string wallname = "ostu_seg.nii.gz";
	//string surfacename = "ostu_seg_surface.nii.gz";
	...
	LALabelName = PathName + "\\en_seg_msp_M.nii.gz";
	GoldLALabelName = PathName + "\\" + wallname;
	MeshWallLabelName = PathName + "\\" + surfacename;


	zxhImageData SourceImage, MeshWallImage, LABloodPoolGaussianBlur, GoldLALabel, LALabel, MeshWallLabelImage;
